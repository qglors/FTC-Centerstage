...
@Autonomous(name = "AutonRedLong")
public class AutonRedLong extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // strafe left sideways until bot reaches parking
        drive(-3700, 3700, 3700, -3700, 0.75);
