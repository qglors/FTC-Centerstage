...
@Override
    public void runOpMode() {
        ...
        // brakes the arm when inactive so arm goes down slower instead of slamming cause of gravity
        LeftArm.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        RightArm.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        
        // brakes the suspension when inactive so suspennsion goes down slower instead of slamming due to gravity
